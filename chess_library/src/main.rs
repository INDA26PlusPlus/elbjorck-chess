...
pub impl Board {
    ...
    pub fn limit_kings(board: &Board, mut all_moves: [u64; 64], all_attacks: [u64; 64]) -> [u64; 64] {
...
pub fn main() {
    ...
    //Board::test_castle(&mut board);

    Board::test_mate(&mut board);
}
